...
class VSSM(nn.Module):
    def __init__(
        ...
        patch_norm=True, 
        norm_layer="LN", #  "ln2d"
        downsample_version: str = "v2", # "v3"
        patchembed_version: str = "v1", #  "v2"
...
class Backbone_VSSM(VSSM):
    def __init__(self, out_indices=(0, 1, 2, 3), pretrained='/mnt/sdb/zhaojiaojiao/models/models/vssm1_tiny_0230s_ckpt_epoch_264.pth', norm_layer="ln", **kwargs):
    ...
    def load_pretrained(self, ckpt='/mnt/sdb/zhaojiaojiao/models/models/vssm1_tiny_0230s_ckpt_epoch_264.pth', key="model"):
        if ckpt is None:
            return
