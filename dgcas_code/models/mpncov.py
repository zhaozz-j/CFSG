...
from models.backbone_bases import Resnet50Fc as resnet50
...
class MPNCOV(nn.Module):
    ...
    def __init__(self, iter_num=5, is_sqrt=True, is_vec=True, is_reduce=True, input_dim=2048, dimension_reduction=None):
        ...
        if self.is_vec is True:
            if self.is_reduce is True:
...
class Covpool(Function):
    ...
    def forward(ctx, input):
        ...
        # print("Out Covpool forward")
        # print("Out Covpool forward")
        return y

    @staticmethod
    def backward(ctx, grad_output):
        # print("Into Covpool backward")
        # print("Into Covpool backward")
...
class Sqrtm(Function):
    ...
    def forward(ctx, input, iterN):
        ...
        ctx.iterN = iterN
        # print("Out Sqrtm forward")
        # print("Out Sqrtm forward")
        return y

    @staticmethod
    def backward(ctx, grad_output):
        # print("Into Sqrtm backward")
        # print("Into Sqrtm backward")
...
class Triuvec(Function):
    ...
    def forward(ctx, input):
        ...
        print("Out Triuvec forward")
        print("Out Triuvec forward")
        return y

    @staticmethod
    def backward(ctx, grad_output):
        # print("Into Triuvec backward")
        # print("Into Triuvec backward")
